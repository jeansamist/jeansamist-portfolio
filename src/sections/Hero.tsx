...
export const Hero: FunctionComponent = () => (
  <section className="hero w-full min-h-screen">
    <div className="w-full min-h-screen px-4 from-indigo-950 bg-gradient-to-t pt-[80px] pb-8 flex justify-center">
      <div className="content flex flex-col-reverse justify-center items-center gap-16">
        <div className="description text-center flex flex-col gap-6">
          <div className="name text-6xl font-extrabold">
            ...
            <div className="line text-indigo-700">EPHRAIM</div>
          </div>
          <div className="bio">
        ...
        <div className="me-image w-[300px] rounded-full overflow-hidden from-indigo-500 bord to-indigo-950 bg-gradient-to-b">
          <Image
            src={me}
            alt="a photo of me"
            priority={true}
